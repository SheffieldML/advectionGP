...
class TestKernels(unittest.TestCase):
    ...
    def test_kernel(self):
        ...
        m = Model(resolution=[40,4,4],boundary=boundary,N_feat=10000,noiseSD=5.0,kernel=k,sensormodel=sensors)
    ...
    def test_grid_volume(self):
        ...
        sensors = FixedSensorModel(X,2)
        m = Model(resolution=[200,200,200],boundary=boundary,N_feat=15,noiseSD=5.0,kernel=k,sensormodel=sensors)
